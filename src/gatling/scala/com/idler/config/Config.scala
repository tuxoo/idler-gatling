...
object Config {
  ...
  private[idler] val ramp: Int = System.getProperty("Ramp", "60").toInt
//  private[idler] val openScnDuration: Int = System.getProperty("OpenScnDuration", "180").toInt
  private[idler] val openScnDuration: Int = System.getProperty("OpenScnDuration", "180").toInt
  private[idler] val closedScnDuration: Int = System.getProperty("ClosedScnDuration", "30").toInt
  private[idler] val stressScnDuration: Int = System.getProperty("StressScnDuration", "10").toInt
...
//  private[idler] val connectionUrl = "jdbc:postgresql://localhost:5432/idler?currentSchema=idler&user=idler&password=qwerty"
  ...
  //  private[idler] val connectionUrl = "jdbc:postgresql://localhost:5432/tolanguage?currentSchema=tolanguage&user=tolanguage&password=qwerty"
  ...
  private[idler] val genUsersCount: Int = System.getProperty("Users", "1000000").toInt
}
